    ...
    <div className="settings-wrapper flex h-screen overflow-hidden">
      ...
      <nav className="hidden md:flex bg-surface-container-lowest/80 backdrop-blur-2xl text-primary font-body-md text-body-md h-screen w-72 flex-col border-r border-white/10 shadow-2xl flex flex-col p-gutter gap-unit z-40">
        ...
        <div className="flex flex-col gap-2 flex-grow">
          {/* New Session */}
          <a className="flex items-center gap-3 px-4 py-3 text-on-surface-variant hover:bg-surface-container-high rounded-lg hover:bg-white/5 transition-all duration-200 hover:translate-x-1" href="#">
          ...
          {/* Settings (ACTIVE) */}
          <a className="flex items-center gap-3 px-4 py-3 bg-primary-container text-on-primary-container rounded-lg font-semibold shadow-[0_0_15px_rgba(88,86,214,0.3)] hover:bg-white/5 transition-all duration-200 hover:translate-x-1" href="#">
                ...
                <div className="space-y-6">
                  ...
                  <div className="group">
                    ...
                    <div className="relative flex items-center">
                      <input className="w-full input-glass py-3 px-4 text-on-surface font-body-md text-body-md rounded-t-lg transition-all" readOnly={true} type="password" defaultValue="sk-proj-8x92nd83nd92..." />
                  ...
                  <div className="group">
                    ...
                    <div className="relative flex items-center">
                      <input className="w-full input-glass py-3 px-4 text-on-surface font-body-md text-body-md rounded-t-lg transition-all" readOnly={true} type="password" defaultValue="sk-ant-api03-..." />
                      <div className="absolute right-2 flex gap-2">
                        <button className="p-2 text-on-surface-variant hover:text-primary transition-colors">
                          <span className="material-symbols-outlined text-[20px]">visibility</span>
                        </button>
